...
Cate_path = 'V:\\Coding\\Project_2\\dataset\\make\\Annotations'
Img_path = 'V:\\Coding\\Project_2\\dataset\\make\\Annotations'
Type = 'jpg'
categroy = ['benign', 'malignant']
                        ...
                        for xml in os.listdir(class_path):
                            ...
                            for image in os.listdir(self.image_path):
                                ...
                                if xml_name[0] == image_name[0]:
                                    ...
                                    shutil.move(source_path, class_path + '\\' + image)
